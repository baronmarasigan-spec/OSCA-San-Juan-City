...
export default function ExpandedCentenariansActManagement({ hideHeader = false }: { hideHeader?: boolean }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Info Banner */}
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-100 rounded-[2rem] p-6 flex flex-col md:flex-row items-start md:items-center gap-5">
        <div className="w-12 h-12 rounded-2xl bg-indigo-100 flex items-center justify-center text-indigo-600 shrink-0">
          <Info className="w-6 h-6" />
        </div>
        <div className="space-y-1">
          <h4 className="text-sm font-bold text-indigo-950 uppercase tracking-wider">National Level Coordination Notice</h4>
          <p className="text-xs text-indigo-800/80 font-medium leading-relaxed">
            The Expanded Centenarians Act (Republic Act No. 11982) cash gifts are funded and disbursed at the National level via the <strong className="text-indigo-950">National Commission of Senior Citizens (NCSC)</strong> and <strong className="text-indigo-950">DSWD</strong>. The local OSCA office manages verification of local candidates and facilitates submission of required proof of residency and birth credentials.
          </p>
        </div>
      </div>
